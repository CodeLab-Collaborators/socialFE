      ...
      >
        ...
        <div className="w-[300px] ">
          <div className="rounded border-orange-200 w-[300px] border p-1 flex flex-col justify-center items-center pb-1 ">
            ...
            {/* content */}
            <div className="w-[70%] text-xs text-center mb-4">
              Sign up to see Photes and Video from your Friends.
            </div>
            ...
            <div className="w-[70%] text-xs text-center mb-4">
              ...
              <span className="text-[#F97316] font-semibold">Terms</span> and{" "}
              <span className="text-[#F97316] font-semibold">Conditions</span>
            </div>

            <button
              className="bg-[#F97316] font-semibold  rounded-sm text-white w-[97%] py-2 hover:scale-[1.015] transition-all duration-300  "
              type="submit"
              onClick={() => {
                onSubmit()
                  .then(() => {
          ...
          <div className="flex items-center justify-center  w-[100%] my-4 p-2 border text-sm ">
            ...
            <Link to="/" className="no-underline text-white">
              <span className="mx-2 text-[#F97316] font-semibold cursor-pointer hover:scale-105 transition-all duration-300 text-sm">
                Log In
              </span>
            </Link>
          </div>
